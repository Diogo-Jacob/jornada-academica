        ...
        <div className="relative overflow-hidden bg-[#102a3d] p-8 text-white sm:p-10">
          ...
          <div className="relative">
            ...
            <p className="mt-4 max-w-2xl leading-7 text-white/75">
              Ocorreu uma falha ao carregar esta página. Você pode tentar
              novamente ou retornar para a página inicial do evento.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 p-8 sm:p-10">
          <div className="rounded-3xl border border-amber-200 bg-amber-50 p-5">
            <p className="text-sm leading-6 text-amber-800">
              Se o erro persistir, entre em contato com a organização da Jornada
              Acadêmica de Medicina e informe em qual página o problema ocorreu.
            </p>
          </div>
